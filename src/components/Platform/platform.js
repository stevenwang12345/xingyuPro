...
class Platform extends React.Component {
	...
	showInfos() {
		layer.alert('<p>名词解释:</p>', {btn: ['我知道了,谢谢'], title: '名词解释', area: '500px'});
	}
	render() {
		return(
			<div>
				<Header />
				<div className="details w1170">
					<div  className="datalist">
						<div className="plat_transaction"><h2>公司详情</h2></div>
		                <div className="conditional">
		                        {
		                        	this.state.report ?
									<div  className="datalist data-list">
					                   <div className="conditional">
						                    <div className="conditionitem">
							                     ...
							                     <div className="company_right">
							                         ...
							                         <div className="company_right_time">
								                         ...
								                         <span className="tel">
								                         {
								                         	this.state.report['servicePhone'] ? <Icon type="phone" style={{color: '#bbb'}} /> : ""
								                         }
			         ...
			         <div className="datalist enterprise">
		                  <div className="plat_transaction"><h2>企业资料</h2></div>
		                  <div className="enterprise-details">
	                      		{
	                      			this.state.baseInfo ?
	                      			 <ul className="enterprise-details-ul">
		                      			<li>
				        ...
				        <div className="datalist enterprise">
				        	 ...
				        	 <ul className="detail-ul">
				        	 	<li onClick={this.setTab.bind(this,0)} style={{background: this.state.currTabIndex==0 ? '#9d6d25':'',color: this.state.currTabIndex==0 ? '#fff':''}}>互金评价</li>
								<li onClick={this.setTab.bind(this,1)} style={{display: this.state.questionType != '00' ? 'none' : '', background: this.state.currTabIndex==1 ? '#9d6d25':'',color: this.state.currTabIndex==1 ? '#fff':''}}>公司简介</li>
				        	 	<li onClick={this.setTab.bind(this,2)} style={{display: this.state.questionType != '00' ? 'none' : '', background: this.state.currTabIndex==2 ? '#9d6d25':'',color: this.state.currTabIndex==2 ? '#fff':''}}>运营数据</li>
		        	 				...
		        	 				<div className="">
				                            ...
				                            <div className="fr">
				                                <div className="detail-title">
				                                    ...
				                                    <em>更新时间：{this.state.report.dataYmd ? this.state.report.dataYmd : "-"}</em>
				                                    <Button className="explain" type="primary" onClick={this.showInfos.bind(this)}>名词解释</Button>
				     								<div id="jieshiBox" style={{display: 'none'}}>
				     									相关名词解释
				     								</div>
											     </div>
											     <ul className="xlist">
								                     	...
								                     	this.state.dimensionls ? this.state.dimensionls && this.state.dimensionls.length > 0 ?
								                       	this.state.dimensionls.map((item, index) => {
					                                         ...
					                                         <div className="rate-data"><span className="arro-up">
					                                         	{item.score ? <span style={{color: '#a06e27'}}>{item.score}</span> : "-"}
					                                         </span></div>
				        	 ...
				        	 <div className="detailMain" style={{display: this.state.currTabIndex==3 ? '' : 'none'}}>
	        	 					<div className="">
	                                    <div className="header-slider-item shareholder">
	                                        <table className="layui-table platdetailTabs">
	                                        	  	<colgroup>
	    												<col width="250" />
	    												<col width="200" />
	    												<col />
				                                 ...
				                                 <tbody>
				                                        {
															...
															this.state.shareholder.map((item, index) => {
																return <tr key={index} >
																	<td>{item.shareholderName ? item.shareholderName : "-"}</td>
																	<td>{item.investmentRate ? <span style={{color: 'green'}}>{item.investmentRate}</span> : "-"}</td>
																	<td>{item.contributedCapital ? <span style={{color: '#6b3906'}}>{item.contributedCapital}</span> : "-"}</td>
																</tr>
															}) : <tr><td colSpan="3" style={{textAlign: 'center', color: 'red'}}>暂无数据</td></tr>		
														}
				                                 </tbody>
	                                        </table>
				        	...
				        	<div className="detailMain" style={{display: this.state.currTabIndex==4 ? '' : 'none'}}>
	    						<div className="">
					               <div className="header-slider-item property">
					                    <table className="layui-table platdetailTabs">
					                    	    <colgroup>
	    												<col width="180" />
	    												<col width="300" />
			                                 ...
			                                 <tbody>
			                                        {
														...
														}) :  <tr><td colSpan="5" style={{textAlign: 'center', color: 'red'}}>暂无数据</td></tr>			
													}
			                                 </tbody>
					                    </table>  
					               </div>
				        	...
				        	<div className="detailMain" style={{display: this.state.currTabIndex==6 ? '' : 'none'}}>
		        					<div className="">
							               <div className="header-slider-item judicial">
							                   <table className="layui-table platdetailTabs">
							                   		<colgroup>
	    												<col width="120" />
	    												<col width="500" />
							                        ...
							                        <thead>
							                            <tr><th>日期</th><th>裁判文书</th><th>案件类型</th><th>案件号</th></tr>
							                        </thead>
					                                 <tbody>
					                                        {
					                                           (this.state.judicial && this.state.judicial.length > 0) ?
																this.state.judicial.map((item, index) => {
																	return <tr key={index} >
																		...
																		<td style={{color: '#9c6c24'}}>{item.caseType ? item.caseType : "-"}</td>
				        	...
				        	<div className="detailMain" style={{display: this.state.currTabIndex==7 ? '' : 'none'}}>
						          <div className="">
					                       <div className="header-slider-item executive">
	...
	_getReport(platformId) {
  	...
  	setPageTitle() {
      var str = this.state.report['platformName'];
      $("title").html("")
      $("title").html(str); 
  	}
  	obj2params(obj) {
